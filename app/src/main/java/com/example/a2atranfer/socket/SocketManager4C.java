 ...
 */
public class SocketManager4C {
    private ServerSocket ss;
    private Handler handler = null;
    private final String TAG = SocketManager4C.this.getClass().getSimpleName();
    ...
    public SocketManager4C(Handler handler, Context context) {
